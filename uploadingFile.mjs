...
//this how to upload files(json) to firestore cloud
//put the uploadingFile on the root of the app folder
//with .mjs

const firebaseConfig = {
  apiKey: "AIzaSyC5Kf2tfQ_yPL2xmAHaaz02EnMC3oNFW48",
  authDomain: "disneyplus-clone-7c64f.firebaseapp.com",
  databaseURL:"https://disneyplus-clone-7c64f-default-rtdb.firebaseio.com",
...
const movies = {
  ...
  for (const key in movies) {
    //used when going through an object
    // with an array foreach would be used like in https://www.youtube.com/watch?v=VlyuaMoMcq8&t=1s&ab_channel=DevNami
    db.collection("movies")
      .add({
        id: key,
        backgroundImg: movies[key].backgroundImg,
        cardImg: movies[key].cardImg,
        description: movies[key].description,
        subTitle: movies[key].subTitle,
        title: movies[key].title,
        titleImg: movies[key].titleImg,
        type: movies[key].type,
      })
      .then((docRef) => {
